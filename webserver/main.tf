...
resource "aws_instance" "bastion" {
  ...
  depends_on = [aws_security_group.bastion_sg, data.terraform_remote_state.network]
...
resource "aws_instance" "web_server" {
  ...
  security_groups        = [aws_security_group.web_server_sg[count.index].name]
  associate_public_ip_address = false
  depends_on = [aws_security_group.web_server_sg, data.terraform_remote_state.network]
